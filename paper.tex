...
The reason these two tasks are complicated is that, as a user, you often don't know what information is relevant. 

rubber duck debugging \cite{Thomas-1999}-- the process of writing a good bug
report is analogous to solving the problem. Often, you can't really do it,
because if you knew what was necessary, you'd be able to solve your problem.

GitHub issue templates \cite{github-templates}
