...
list, check that first. Not only will that get you your solution faster, it will
likely save you from some grumbling by the developers.
...
For a feature request, you would also describe what you hope to accomplish and
how you'd like to see it work, as well as any current workaround you've
developed.

However, writing the initial bug report is only the first step.
